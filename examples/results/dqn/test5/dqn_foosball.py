...
agent = DQNAgent(model=model, nb_actions=nb_actions, memory=memory, nb_steps_warmup=200,
               target_model_update=1e-3, policy=policy, processor=processor, batch_size=128)
...
agent.fit(env, callbacks=callbacks, nb_steps=250000, nb_max_episode_steps=200, visualize=False, verbose=0)
