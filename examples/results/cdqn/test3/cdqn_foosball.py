...
agent = ContinuousDQNAgent(nb_actions=nb_actions, V_model=V_model, L_model=L_model, mu_model=mu_model,
                 ...
                 gamma=.99, target_model_update=1e-3, processor=processor, batch_size=128)
...
agent.fit(env, nb_steps=500000, visualize=False, verbose=0, nb_max_episode_steps=200, callbacks=callbacks)
